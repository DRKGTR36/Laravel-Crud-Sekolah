            ...
            <div class="container">
                <div class="row fullscreen d-flex align-items-center justify-content-between">
                    <div class="banner-content col-lg-9 col-md-12">
                        <h1 class="text-uppercase">{{config('sekolah.welcome_message')}}</h1>
                        <p class="pt-10 pb-10">{{config('sekolah.sub_welcome_message')}}</p>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 single-blog">
                        ...
                        <p class="meta">{{$post->created_at->format('D d M Y')}} | oleh <a href="#">{{$post->user->nama}}</a></p>
